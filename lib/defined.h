...
#define	RET_VALUE_OBJECT_EXISTS			11
#define	RET_VALUE_OBJECT_NOT_FOUND		12
#define	RET_VALUE_DEVICE_DOES_NOT_EXIST	13
#define	RET_VALUE_OBJECT_IS_NOT_INITIALIZED	14
#define	RET_VALUE_DEVICE_NOT_ACTIVATED	15
